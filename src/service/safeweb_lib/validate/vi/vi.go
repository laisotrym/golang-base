package safeweb_lib_validate_vi
...
func RegisterDefaultTranslations(v *validator.Validate, trans ut.Translator) (err error) {
    ...
    translations := []struct {
        ...
        {
            tag:         "required",
            translation: "{0} không được để trống",
            override:    false,
        },
        {
            tag: "len",
            customRegisFunc: func(ut ut.Translator) (err error) {
                ...
                if err = ut.Add("len-string", "{0} phải dài chính xác {1} ký tự", false); err != nil {
                    return
                }
        ...
        },
        {
            ...
            customRegisFunc: func(ut ut.Translator) (err error) {
                ...
                if err = ut.Add("min-string", "{0} yêu cầu tối thiểu {1} độ dài", false); err != nil {
                    return
                }
        ...
        },
        {
            ...
            customRegisFunc: func(ut ut.Translator) (err error) {
                ...
                if err = ut.Add("lte-string", "{0} không quá {1} độ dài", false); err != nil {
                    return
                }
                ...
                if err = ut.Add("lte-number", "{0} nhỏ hơn hoặc bằng {1}", false); err != nil {
                    return
                }
        ...
        },
        {
            ...
            customRegisFunc: func(ut ut.Translator) (err error) {
                ...
                if err = ut.Add("gte-string", "{0} phải dài ít nhất {1} ký tự", false); err != nil {
                    return
                }
                
                if err = ut.AddCardinal("gte-string-character", "{0}", locales.PluralRuleOne, false); err != nil {
                    return
                }
                
                if err = ut.AddCardinal("gte-string-character", "{0}", locales.PluralRuleOther, false); err != nil {
                    return
                }
        ...
        {
            tag:         "email",
            translation: "{0} không đúng định dạng email",
            override:    false,
        },
        {
            tag:         "url",
            translation: "{0} không đúng định dạng url",
            override:    false,
        },
        {
            tag:         "uri",
            translation: "{0} không đúng định dạng URI",
            override:    false,
        },
        {
            tag:         "base64",
        ...
        {
            tag:         "oneof",
            translation: "{0} phải là một trong các giá trị [{1}]",
            override:    false,
            customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
        ...
        {
            tag:         "code",
            translation: "{0} chỉ bao gồm các ký tự (a-z),(A-Z),(0-9), -, _ viết liền",
            override:    false,
        },
        {
            tag:         "api",
            translation: "{0} không đúng định dạng url api",
            override:    false,
        },
        {
            tag:         "optional_len_lte",
            translation: "{0} dài không quá {1} ký tự",
            override:    false,
            customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
        ...
        {
            tag:         "optional_len_gte",
            translation: "{0} không ngắn hơn {1} ký tự",
            override:    false,
            customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
        ...
        {
            tag:         "optional_len",
            translation: "{0} phải chứa chính xác {1} ký tự",
            override:    false,
            customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
