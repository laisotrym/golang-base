...
func StandardisedProtoJSONMarshaler(removeOriginalResponseDataFields bool) runtime.ServeMuxOption {
	// set error handler to standardise error response
	...
	return runtime.WithMarshalerOption(runtime.MIMEWildcard, &JSONPbMarshaler{
		...
		removeOriRespDataFields: removeOriginalResponseDataFields,
	})
}
